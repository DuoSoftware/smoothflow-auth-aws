const URLS_ = {
    ...
    workspaces: {
        ...
        ready_workspace: 'https://useracountmanager.plus.smoothflow.io/dbf/api/1.0.0.0/setup/useraccount',
        get_permissions : 'https://useracountmanager.plus.smoothflow.io/dbf/api/1.0.0.0/user/permissions'
    },
    subscription: {
