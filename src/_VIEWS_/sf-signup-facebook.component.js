...
class SignInWithFacebook extends Component {
    ...
    signIn() {
        ...
        if (window.location.hostname == "localhost" ||
            ...
            url = 'https://smoothflow-prod.auth.us-east-1.amazoncognito.com/oauth2/authorize?redirect_uri=https://smoothflow.io/account&response_type=token&client_id=7h0k235kelpooui6etj31mcntr&identity_provider=Facebook';
        }
        window.location = url;
